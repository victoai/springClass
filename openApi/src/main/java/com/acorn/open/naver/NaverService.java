...
public class NaverService {
    ...
    public static void main(String[] args) {
      /*  String clientId = "QaMZOIzquZ2XCHAFDEMN"; //애플리케이션 클라이언트 아이디
        ...
        */
    	NaverService  search = new NaverService();
    	String response  = search.getShoppingList();
    	ArrayList<ItemDto> result  =search.fromJsonItem(response);
    ...
    public ArrayList<ItemDto> fromJsonItem( String response){
