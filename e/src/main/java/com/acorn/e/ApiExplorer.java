...
//E5K0ShAsEn6REfEqdHEQUWpQZ9F8RxQQLyrTHDmRibvbjSi2KEhW9vQcY3KNQHChKE0lSyL93L0VTZw7Rd6EUQ%3D%3D
public class ApiExplorer {
    public static void main(String[] args) throws IOException {
        ...
        urlBuilder.append("&" + URLEncoder.encode("listYN","UTF-8") + "=" + URLEncoder.encode("Y", "UTF-8")); /*통보코드검색(PM10, PM25, O3)*/
